...
const socket_transport_1 = (0, tslib_1.__importDefault)(require("@deficonnect/socket-transport"));
...
class Connector {
    constructor(opts) {
        ...
        this._clientMeta = opts.connectorOpts.clientMeta || (0, utils_1.getClientMeta)() || null;
    ...
    sendJSONRequest(jsonRequest, options) {
        var _a, _b;
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const request = {
            ...
            const encryptionPayload = yield this._encrypt(request);
            const topic = this.peerId;
            const payload = JSON.stringify(encryptionPayload);
            const silent = (_b = !(options === null || options === void 0 ? void 0 : options.forcePushNotification)) !== null && _b !== void 0 ? _b : (0, utils_1.isSilentPayload)(request);
