...
export declare function getInfuraRpcUrl(chainId: string, infuraId?: string): string | undefined;
export declare function getRpcUrl(chainId: string, rpc: IRpcConfig): string | undefined;
