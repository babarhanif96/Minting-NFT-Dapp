...
import { IRPCMap, IConnector, IJsonRpcResponseSuccess, IWalletConnectProviderOptions, IQRCodeModalOptions } from "@deficonnect/types";
...
declare class WalletConnectProvider extends ProviderEngine {
    ...
    get walletMeta(): import("@deficonnect/types").IClientMeta | null;
    ...
    updateRpcUrl(chainId: string, chainType: string, rpcUrl?: string | undefined): void;
