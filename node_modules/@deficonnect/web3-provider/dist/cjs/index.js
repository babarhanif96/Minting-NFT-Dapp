...
const client_1 = (0, tslib_1.__importDefault)(require("@deficonnect/client"));
const qrcode_modal_1 = (0, tslib_1.__importDefault)(require("@deficonnect/qrcode-modal"));
const http_connection_1 = (0, tslib_1.__importDefault)(require("@deficonnect/http-connection"));
const utils_1 = require("@deficonnect/utils");
...
class WalletConnectProvider extends ProviderEngine {
    constructor(opts) {
        ...
        this.send = (payload, callback) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            payload = Object.assign({ id: (0, utils_1.payloadId)(), jsonrpc: "2.1" }, payload);
    ...
    updateState(sessionParams) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const { accounts, chainId, chainType, networkId, rpcUrl } = sessionParams;
    ...
    updateRpcUrl(chainId, chainType, rpcUrl = "") {
